# SmartBin-STM32-RTOS
an automated, real-time waste management system based on STM32, utilizing FreeRTOS, interrupt-driven task notification, and watchdog timer for robust performance.
# Project Overview
